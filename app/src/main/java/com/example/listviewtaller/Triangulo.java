...
public class Triangulo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatoBase = findViewById(R.id.lblDatoTrianguloBase);
        DatoAltura = findViewById(R.id.lblDatoTrianguloAltura);
        txtBase = findViewById(R.id.txtCalcularTrianguloBase);
        txtAltura = findViewById(R.id.txtCalcularTrianguloAltura);
    }
    ...
    public void guardar(View v){
        ...
        operacion = getResources().getString(R.string.guardar_AreaDelTriangulo);

        Operaciones Op;
        if(validar()){
            dato = txtBase.getText().toString() +": "+ DatoBase.getText().toString()+" - "+txtAltura.getText().toString() +": "+ DatoAltura.getText().toString();
            resultado = Integer.toString( (Integer.parseInt(DatoBase.getText().toString()) * Integer.parseInt(DatoAltura.getText().toString())) /2 );
